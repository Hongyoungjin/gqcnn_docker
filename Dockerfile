# This Dockerfile is used to build an ROS + GQ-CNN + Tensorflow image based on Ubuntu 18.04
...
RUN pip2 install opencv-python==4.2.0.32 autolab-core==0.0.14
RUN pip2 install autolab-perception==0.0.8 
RUN pip2 install imageio==2.6.1 
RUN pip2 install pyglet==1.4.10 
RUN pip2 install visualization==0.1.1 
RUN pip2 install psutil==5.4.2 
RUN pip2 install gputil==1.4.0 
RUN pip2 install scikit-video==1.1.11 
RUN pip2 install .
